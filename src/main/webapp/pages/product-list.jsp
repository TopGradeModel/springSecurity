			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="${pageContext.request.contextPath}/permission/oneQuery"'>
						...
						<!--数据列表-->
						<form action="${pageContext.request.contextPath }/product/delMany" method="post" id="delForm">
						<table id="dataList"
							...
							<tbody>
								<c:forEach items="${pageinfo.list}" var="product">
									<tr>
										...
										<td><fmt:formatDate value="${product.departureTime }"
