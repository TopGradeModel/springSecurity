...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form
				action="${pageContext.request.contextPath}/role/addRolePermission"
				method="post">
				...
				<section class="content"> <input type="hidden" name="roleId"
					...
					<table id="dataList"
							...
							<tbody>
								<c:forEach items="${findPermission}" var="permission">
									<tr>
										<td><input name="ids" ${fn:contains(str,",".concat(permission.id).concat(","))?"checked":""} type="checkbox" value="${permission.id}"></td>
										<td>${permission.id}</td>
