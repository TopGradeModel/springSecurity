...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/permission/savePs"
				method="post">
				<!-- 正文区域 -->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">父权限名称</div>
						<div class="col-md-4 data">
							<select class="form-control" name="">
							<c:forEach items="${oneQueryPs}" var="ps">
								<option value="${ps.id}">${ps.permissionName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
