									...
									<c:forEach items="${findUser}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/detailUser?id=${user.id }" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/roleView?userId=${user.id }" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
